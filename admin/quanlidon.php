      ...
      <div class="w-full bg-white p-6 rounded-2xl ">
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <form method="GET" action="">
                <input type="text" name="search" placeholder="Tìm kiếm theo số điện thoại" value="<?= htmlspecialchars($search) ?>" class="border px-4 py-2 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <?php
            $params = $_GET;
            $currentUrl = strtok($_SERVER["REQUEST_URI"], '?'); // lấy URL không có query string
            ?>
                    ...
                    <form action="" method="GET" class="space-y-4 text-sm text-gray-700">
                        <div class="grid grid-cols-2 gap-4">
                            <select name="province" id="province" class="px-4 py-2 border rounded-md text-gray-700 focus:ring-2 focus:ring-blue-500">
                                ...
                                <!-- Giả sử bạn đã load tỉnh từ JS, giữ lại lựa chọn -->
