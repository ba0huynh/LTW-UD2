...
<body>
    ...
    <div id="filterModal" class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 hidden">
        <div class="bg-white w-full max-w-xs rounded-2xl p-6 shadow-xl relative">
            <!-- Nút đóng -->
            ...
            <div>
                <label class="block font-medium mb-1">Mã đơn hàng:</label>
                <input type="text" name="order_id" placeholder="Nhập mã đơn hàng" class="w-full border-b px-2 py-1 focus:outline-none focus:border-indigo-500">
            </div>

            <div>
                <label class="block font-medium mb-1">Tên khách hàng:</label>
                <input type="text" name="customer" placeholder="Nhập tên khách hàng" class="w-full border-b px-2 py-1 focus:outline-none focus:border-indigo-500">
            </div>
