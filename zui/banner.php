...
<div class="w-full bg-white px-4 py-6">
  <div class="max-w-[1600px] mx-auto flex flex-col items-center">
    <div class="grid grid-cols-3 gap-4 w-full">
      <!-- Main Banner -->
      <div class="col-span-2 relative rounded overflow-hidden">
      ...
      <div class="flex flex-col gap-4">
        <img src="https://cdn1.fahasa.com/media/wysiwyg/Thang-04-2025/ShopeeT4_392x156.png" alt="Voucher Banner" class="w-full h-auto rounded">
        <img src="https://cdn1.fahasa.com/media/wysiwyg/Thang-04-2025/homecreditT4_392x156.png" alt="Home Credit Banner" class="w-full h-auto rounded">
      </div>
    </div>

    <!-- Promotions Row -->
    <div class="grid grid-cols-4 gap-4 mt-6 w-full">
      <img src="https://cdn1.fahasa.com/media/wysiwyg/Thang-04-2025/ctt3_t4_ngap_vang_310x210_3.jpg" class="w-full rounded" />
      <img src="https://cdn1.fahasa.com/media/wysiwyg/Thang-04-2025/hotwheel0424_smallbanner_310x210_04.jpg" class="w-full rounded" />
      <img src="https://cdn1.fahasa.com/media/wysiwyg/Thang-04-2025/MinhLong_KC_310x210.png" class="w-full rounded" />
      <img src="https://cdn1.fahasa.com/media/wysiwyg/Thang-04-2025/NgoaiVanT4_Resize_310x210.png" class="w-full rounded" />
    </div>
  </div>
</div>
