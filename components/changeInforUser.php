      ...
      <form action="" method="post" >
        <div class=" bg-white rounded-2xl shadow-md p-8">
            ...
            <div class="mb-4">
              <label class="block text-gray-700 font-medium mb-1">
                Số điện thoại 
                <span class="text-blue-600 cursor-pointer text-sm">Thay đổi</span>
              </label>
              <input value="<?php echo $user["phoneNumber"] ?>" name="phoneNumber" type="text"  
              class="w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" />
            </div>
            ...
            <div class="mb-6">
              ...
              <div class="grid grid-cols-3 gap-4 mt-2">
                <input value="" name="dateOfBirth" type="text" placeholder="DD" maxlength="2" 
                class="w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" />
                
                <input value="" name="monthOfBirth" type="text" placeholder="MM" maxlength="2" 
                class="w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" />
                
                <input value="" name="yearOfBirth" type="text" placeholder="YYYY" maxlength="4" 
                class="w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500" />
