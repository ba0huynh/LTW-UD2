...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 10, 2025 lúc 05:01 AM
...
--
-- Cấu trúc bảng cho bảng `permissionrole`
--

CREATE TABLE `permissionrole` (
  `id` int(11) NOT NULL,
  `roleId` int(11) NOT NULL,
  `chucnangId` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Đang đổ dữ liệu cho bảng `permissionrole`
--

INSERT INTO `permissionrole` (`id`, `roleId`, `chucnangId`) VALUES
(1, 1, 5),
(2, 1, 8),
(3, 1, 7),
(4, 1, 10),
...
(2, 2, 'minhtran', '$2y$10$IMFONH6sSOMQbjUElSu/Qe2NNqUfoH6eaPgwQsuLmgWQdNN8kl72e', 'minhtran@gmail.com', 'https://icons.iconarchive.com/icons/papirus-team/papirus-status/512/avatar-default-icon.png', 1, 'Minh Trần', '0911222333'),
(3, 1, 'thaole', '$2y$10$IMFONH6sSOMQbjUElSu/Qe2NNqUfoH6eaPgwQsuLmgWQdNN8kl72e', 'thaole@gmail.com', 'https://icons.iconarchive.com/icons/papirus-team/papirus-status/512/avatar-default-icon.png', 1, 'Thảo Lê', '0911333444'),
(4, 2, 'huypham', '$2y$10$IMFONH6sSOMQbjUElSu/Qe2NNqUfoH6eaPgwQsuLmgWQdNN8kl72e', 'huypham@gmail.com', 'https://icons.iconarchive.com/icons/papirus-team/papirus-status/512/avatar-default-icon.png', 1, 'Huy Phạm', '0911444555'),
(5, 3, 'lanho', '$2y$10$IMFONH6sSOMQbjUElSu/Qe2NNqUfoH6eaPgwQsuLmgWQdNN8kl72e', 'lanho@gmail.com', 'https://icons.iconarchive.com/icons/papirus-team/papirus-status/512/avatar-default-icon.png', 1, 'Lan Hồ', '0911555666'),
(6, 3, 'namdang', '$2y$10$IMFONH6sSOMQbjUElSu/Qe2NNqUfoH6eaPgwQsuLmgWQdNN8kl72e', 'namdang@gmail.com', 'https://icons.iconarchive.com/icons/papirus-team/papirus-status/512/avatar-default-icon.png', 1, 'Nam Đặng', '0911666777'),
(7, 2, 'tuvu', '$2y$10$IMFONH6sSOMQbjUElSu/Qe2NNqUfoH6eaPgwQsuLmgWQdNN8kl72e', 'tuvu@gmail.com', 'https://icons.iconarchive.com/icons/papirus-team/papirus-status/512/avatar-default-icon.png', 1, 'Tú Vũ', '0911777888'),
...
--
-- Chỉ mục cho bảng `permissionrole`
--
ALTER TABLE `permissionrole`
  ADD PRIMARY KEY (`id`),
  ADD KEY `chucnangId` (`chucnangId`),
  ADD KEY `fk_rolewithhpermissionrole` (`roleId`);
...
--
-- AUTO_INCREMENT cho bảng `permissionrole`
--
ALTER TABLE `permissionrole`
...
--
-- Các ràng buộc cho bảng `permissionrole`
--
ALTER TABLE `permissionrole`
  ADD CONSTRAINT `fk_chucnangwithpermissionrole` FOREIGN KEY (`chucnangId`) REFERENCES `chucnang` (`id`),
  ADD CONSTRAINT `fk_roleewithpermissionrole` FOREIGN KEY (`roleId`) REFERENCES `role` (`role_id`),
  ADD CONSTRAINT `fk_rolewithhpermissionrole` FOREIGN KEY (`roleId`) REFERENCES `role` (`role_id`),
  ADD CONSTRAINT `fk_rolewithpermissionrole` FOREIGN KEY (`roleId`) REFERENCES `role` (`role_id`),
  ADD CONSTRAINT `fk_rolewwithpermissionrole` FOREIGN KEY (`roleId`) REFERENCES `role` (`role_id`);
